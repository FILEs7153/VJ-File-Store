...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 ᴄʜᴀɴɴᴇʟ', url='https://t.me/FilesUlagam0')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+BBhMHZ2Xh7M5ZDY1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/FilesUlagam0')
            ],[
        ...
        try:
            ...
            g = await msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                         InlineKeyboardButton('🚀 Dont Click / No Use 🖥️', callback_data=f'generate_stream_link:{file_id}')
                     ]
                    ]
                )
            )
...
# Ask Doubt on telegram @KingVJ01
            ...
            await log_msg.reply_text(
                ...
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀 Don't Click 🚀", url=download),  # we download Link
                                                    InlineKeyboardButton('🖥️ No use 🖥️', url=stream)]])  # web stream Link
            )
